...
library(tidyverse)
Halle_tapnet_web <- readRDS("Data/Working_files/Halle_obj_TAPNET_Late_season_WITH_REGULAR_traits.rds")
Halle_tapnet_fit <- readRDS("Data/Working_files/Halle_fit_TAPNET_Late_season_WITH_REGULAR_traits.rds")
Halle_tapnet_gof <- readRDS("Data/Working_files/Halle_gof_TAPNET_Late_season_WITH_REGULAR_traits.rds")

Jena_tapnet_web <- readRDS("Data/Working_files/Jena_obj_TAPNET_Late_season_WITH_REGULAR_traits.rds")
Jena_tapnet_fit <- readRDS("Data/Working_files/Jena_fit_TAPNET_Late_season_WITH_REGULAR_traits.rds")
Jena_tapnet_gof <- readRDS("Data/Working_files/Jena_gof_TAPNET_Late_season_WITH_REGULAR_traits.rds")

Leipzig_tapnet_web <- readRDS("Data/Working_files/Leipzig_obj_TAPNET_Late_season_WITH_REGULAR_traits.rds")
Leipzig_tapnet_fit <-readRDS("Data/Working_files/Leipzig_fit_TAPNET_Late_season_WITH_REGULAR_traits.rds")
Leipzig_tapnet_gof <- readRDS("Data/Working_files/Leipzig_gof_TAPNET_Late_season_WITH_REGULAR_traits.rds")
