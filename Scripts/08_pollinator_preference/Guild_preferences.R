...
saveRDS(block_mats_guild, "Data/Working_files/block_mats_guild_split_bees.rds")
saveRDS(M_obs_guild, "Data/Working_files/M_obs_guild_split_bees.rds")
saveRDS(M_exp_guild, "Data/Working_files/M_exp_guild_split_bees.rds")
saveRDS(M_sd_guild, "Data/Working_files/M_sd_guild_split_bees.rds")
saveRDS(SES_guild, "Data/Working_files/SES_guild_split_bees.rds")
saveRDS(pval_df_guild, "Data/Working_files/pval_df_guild_split_bees.rds")