...
saveRDS(block_mats_guild, "Data/Working_files/block_mats_guild_split_bees25.rds")
saveRDS(M_obs_guild, "Data/Working_files/M_obs_guild_split_bees25.rds")
saveRDS(M_exp_guild, "Data/Working_files/M_exp_guild_split_bees25.rds")
saveRDS(M_sd_guild, "Data/Working_files/M_sd_guild_split_bees25.rds")
saveRDS(SES_guild, "Data/Working_files/SES_guild_split_bees25.rds")
saveRDS(pval_df_guild, "Data/Working_files/pval_df_guild_split_bees25.rds")