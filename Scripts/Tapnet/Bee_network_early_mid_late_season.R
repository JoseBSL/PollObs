...
total_time_species = interaction_data %>%
  dplyr::select(Botanical_garden, Season, Plants, Date, Total_time_species) %>% 
...
# ======================================================
# Save data
saveRDS(net_by_garden, "Data/Working_files/networks_by_garden_only_phenobs_bees_season.rds")
