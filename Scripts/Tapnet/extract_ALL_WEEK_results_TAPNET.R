...
for (garden_number in 1:length(gardens)) {
  ...
  for (week_number in 1:length(week)) {
    ...
    result <- try({
      ...
      aux_result_tapnet_ALL_WEEKS <- tibble(
      ...
      result_tapnet_ALL_WEEKS <- bind_rows(result_tapnet_ALL_WEEKS, aux_result_tapnet_ALL_WEEKS) 
...
result_tapnet_ALL_WEEKS_FINAL <- result_tapnet_ALL_WEEKS %>%
  left_join(groupped_dates) %>% dplyr::select(Botanical_garden, Season, Week,
                                        Variable, Value)
  

name_tapnet_ALL_WEEK <- "Data/Working_files/results_TAPNET_ALL_WEEK_WITH_REGULAR_traits.rds"
name_tapnet_ALL_WEEK_csv <- "Data/Working_files/results_TAPNET_ALL_WEEK_WITH_REGULAR_traits.csv"
saveRDS(result_tapnet_ALL_WEEKS_FINAL, name_tapnet_ALL_WEEK)
readr::write_csv(result_tapnet_ALL_WEEKS_FINAL, name_tapnet_ALL_WEEK_csv)
