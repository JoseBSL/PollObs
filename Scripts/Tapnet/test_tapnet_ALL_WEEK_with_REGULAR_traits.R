...
floral_ab_WEEK_by_sp <- readr::read_csv("Data/Working_files/total_floral_abundance_by_WEEK_sp_ALL.csv")
poll_ab_WEEK_by_sp <- readr::read_csv("Data/Working_files/total_poll_abundance_by_WEEK_sp_ALL.csv")
