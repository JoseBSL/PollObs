...
readr::write_csv(plant_abundance_season_week,"Data/Working_files/total_floral_abundance_by_WEEK_sp.csv")
readr::write_csv(poll_abundance_season_week,"Data/Working_files/total_poll_abundance_by_WEEK_sp.csv")
