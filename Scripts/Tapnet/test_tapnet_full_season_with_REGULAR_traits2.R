...
for (garden_number in 1:length(gardens)) {
  ...
  # save info
  name_tapnet_obj <- paste0("Data/Working_files/",garden_name,"_obj_TAPNET_full_season_WITH_REGULAR_traits2.rds")
  name_fit <- paste0("Data/Working_files/",garden_name,"_fit_TAPNET_full_season_WITH_REGULAR_traits2.rds")
  name_gof <- paste0("Data/Working_files/",garden_name,"_gof_TAPNET_full_season_WITH_REGULAR_traits2.rds")
