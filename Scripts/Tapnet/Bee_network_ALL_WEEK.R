...
net_by_garden_WEEK = left_join(networks_by_garden_interactions,
                               networks_by_garden_int_frequency)


# ======================================================
# Save data
saveRDS(net_by_garden_WEEK, "Data/Working_files/networks_by_garden_only_phenobs_bees_WEEK_ALL.rds")
