...
# ---- Load inputs ----
abundance_week   <- readRDS("Data/Working_files/Mantel_abund_week_result.rds")
abundance_season <- readRDS("Data/Working_files/Mantel_abund_season_result.rds")
abundance_full   <- readRDS("Data/Working_files/Mantel_abund_full_result.rds")
...
saveRDS(main_abundance_plot, "Data/Working_files/main_abundance_plot_mantel.rds")
