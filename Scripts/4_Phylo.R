...
#Save data
saveRDS(plant_dist_matrix, "Data/Working_files/plant_dist_matrix.rds")
# ======================================================
...
#Save data
saveRDS(poll_dist_matrix, "Data/Working_files/pollinator_dist_matrix.rds")

ggtree(tr, size=0.1, open.angle=5, alpha=0.5) +
  geom_tippoint(colour='cyan4') +
  geom_tiplab(linetype='dashed', linesize=.05, 
              size=1.75, color= "black", offset = 0.2, fontface=2) +
  theme(plot.margin = margin(5, 50, 5, 5)) +
