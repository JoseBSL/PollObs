...
readr::write_csv(average_specialization,"Data/Working_files/average_d_prime_by_week_corrected_by_ab.csv")
readr::write_csv(species_specialization_Garden_Week,"Data/Working_files/species_d_prime_by_week_corrected_by_ab.csv")
