...
interaction_data_freq = interaction_frequency %>%
  left_join(total_time_species, by = c("Botanical_garden", "Sampling_week", "Plants"), suffix = c("", "_summed")) %>%
...
# ======================================================
#Save data
saveRDS(net_by_garden, "Data/Working_files/networks_by_garden_and_week_only_phenobs_pheno.rds")
