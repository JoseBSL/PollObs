...
# --- Load inputs ---
pheno_week   <- readRDS("Data/Working_files/Mantel_trait_week_result.rds")
pheno_season <- readRDS("Data/Working_files/Mantel_trait_season_result.rds")
pheno_full   <- readRDS("Data/Working_files/Mantel_trait_full_result.rds")
...
# --- Plot ---
panel3 <- ggplot(pheno_week_box, aes(x = Season, y = Mantel_corr, fill = Season)) +
