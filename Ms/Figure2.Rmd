...
```{r ,echo=FALSE, message=FALSE, cache=FALSE, warning=FALSE, fig.height=6,fig.width=8, out.width="100%"}
...
p1 = ggplot(data_long, aes(x = Variable, y = Value, fill = Pollinator_order)) + 
  ...
  theme(axis.text.y = element_text(size=14), 
        ...
        axis.title.x = element_text(face="bold", size = 14, angle = 45),
