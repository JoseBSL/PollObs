...
```{r ,echo=FALSE, message=FALSE, cache=FALSE, warning=FALSE, fig.height=9,fig.width=12,out.width="95%", fig.cap= "\\textbf{Figure S7}. Heatmap of standardized effect sizes (SES) comparing observed plant-pollinator interactions at the family level with expectations from a spatiotemporally constrained null model. Purple indicates avoidance and orange indicates association relative to the null expectation. Black dots denote significant deviations from the null model (\\textit{p} < 0.01). Crossed white cells indicate plant-pollinator family pairs that never co-occurred within the same garden and sampling week."}
